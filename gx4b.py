...
starty = Anchors['A'][1]-Disks_on_Sites['A']*28+(29-Disks_on_Sites['A'])
totaly = starty - 39
incry = totaly // 10
for i in range(10):
   #tempy = Anchors['A'][1]-Disks_on_Sites['A']*28+(29-Disks_on_Sites['A'])
   #XY.append((Anchors['A'][0], Anchors['A'][1]-Disk_on_Sites['A']*28-i*10))
...
Ly=Anchors['C'][1]-Disks_on_Sites['C']*28+(29-Disks_on_Sites['C']) - tmp_y
incry = Ly//10
iy= tmp_y# incry
...
caty=10
X = Anchors['A'][0]
Y = Anchors['A'][1]-Disks_on_Sites['A']*28+23
idx = 0
De = 0
