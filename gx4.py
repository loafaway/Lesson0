...
fontObj = pygame.font.Font(r'c:\windows\fonts\kaiu.ttf', 28)
fontObj.set_bold(True)
fontObj.set_underline(True)
fontObj2 = pygame.font.Font(r'c:\windows\fonts\kaiu.ttf', 20)
